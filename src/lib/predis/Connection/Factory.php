...
class Factory implements FactoryInterface
{
    ...
    protected $schemes = array(
        'tcp' => 'Mohamed205\voxum\lib\predis\Connection\StreamConnection',
        'unix' => 'Mohamed205\voxum\lib\predis\Connection\StreamConnection',
        'tls' => 'Mohamed205\voxum\lib\predis\Connection\StreamConnection',
        'redis' => 'Mohamed205\voxum\lib\predis\Connection\StreamConnection',
        'rediss' => 'Mohamed205\voxum\lib\predis\Connection\StreamConnection',
        'http' => 'Mohamed205\voxum\lib\predis\Connection\WebdisConnection',
    );
    ...
    protected function checkInitializer($initializer)
    {
        ...
        if (!$class->isSubclassOf('Mohamed205\voxum\lib\predis\Connection\NodeConnectionInterface')) {
