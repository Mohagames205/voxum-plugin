...
namespace Mohamed205\voxum\lib\predis\Connection\Replication;
...
use Mohamed205\voxum\lib\predis\Connection\ConnectionException;
use Mohamed205\voxum\lib\predis\Connection\FactoryInterface as ConnectionFactoryInterface;
use Mohamed205\voxum\lib\predis\Connection\NodeConnectionInterface;
use Mohamed205\voxum\lib\predis\Connection\Parameters;
use Mohamed205\voxum\lib\predis\Replication\ReplicationStrategy;
use Mohamed205\voxum\lib\predis\Replication\RoleException;
    ...
    public function getSentinelConnection()
    {
        if (!$this->sentinelConnection) {
            if ($this->sentinelIndex >= count($this->sentinels)) {
                ...
                throw new \Mohamed205\voxum\lib\predis\ClientException('No sentinel server available for autodiscovery.');
            }
