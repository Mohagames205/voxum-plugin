...
namespace Mohamed205\voxum\lib\predis;

use Mohamed205\voxum\lib\predis\Command\CommandInterface;
use Mohamed205\voxum\lib\predis\Command\RawCommand;
use Mohamed205\voxum\lib\predis\Command\ScriptCommand;
use Mohamed205\voxum\lib\predis\Configuration\Options;
...
use Mohamed205\voxum\lib\predis\Connection\Parameters;
use Mohamed205\voxum\lib\predis\Connection\ParametersInterface;
use Mohamed205\voxum\lib\predis\Monitor\Consumer as MonitorConsumer;
use Mohamed205\voxum\lib\predis\Pipeline\Pipeline;
use Mohamed205\voxum\lib\predis\PubSub\Consumer as PubSubConsumer;
...
use Mohamed205\voxum\lib\predis\Transaction\MultiExec as MultiExecTransaction;
...
class Client implements ClientInterface, \IteratorAggregate
{
    ...
    /** @var \Mohamed205\voxum\lib\predis\Command\FactoryInterface */
    private $commands;
    ...
    protected function createPipeline(array $options = null, $callable = null)
    {
        if (isset($options['atomic']) && $options['atomic']) {
            $class = 'Mohamed205\voxum\lib\predis\Pipeline\Atomic';
        } elseif (isset($options['fire-and-forget']) && $options['fire-and-forget']) {
            $class = 'Mohamed205\voxum\lib\predis\Pipeline\FireAndForget';
        } else {
            $class = 'Mohamed205\voxum\lib\predis\Pipeline\Pipeline';
        }
