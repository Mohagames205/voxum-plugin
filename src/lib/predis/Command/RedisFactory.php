...
namespace Mohamed205\voxum\lib\predis\Command;
...
class RedisFactory extends Factory
{
    ...
    {
        $this->commands = array(
            'ECHO' => 'Mohamed205\voxum\lib\predis\Command\Redis\ECHO_',
            'EVAL' => 'Mohamed205\voxum\lib\predis\Command\Redis\EVAL_',
            'OBJECT' => 'Mohamed205\voxum\lib\predis\Command\Redis\OBJECT_',
        );
    }
    ...
    public function getCommandClass(string $commandID): ?string
    {
        ...
        } elseif (class_exists($commandClass = "Mohamed205\\voxum\\lib\\predis\\Command\Redis\\$commandID")) {
